...
<div x-data="{ showSideBar: {{ IyiCode\App\Services\SideBar::isDisabled() ? false : (IyiCode\App\Services\SideBar::isAlwaysVisible() ? true : "localStorage.getItem('showSideBar') === 'true'") }} }" class="hidden xl:block absolute z-0 container mx-auto left-0 right-0">
