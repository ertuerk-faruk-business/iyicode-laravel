...
namespace IyiCode\Livewire;

use IyiCode\Livewire\View\Components\Collection as ComponentsCollection;
use IyiCode\Livewire\View\Components\Component as ViewComponent;
use IyiCode\Livewire\View\Components\Input;
...
abstract class View extends Component
{
    ...
    public function updatedData($value, $key)
    {
        ...
        $this->emit('iyicode_laravel_url_changes', $urlParameters);
    }
